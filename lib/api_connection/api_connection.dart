class API
{
  static const hostConnect = "http://10.10.86.205/api_daric";
  ...
  static const hostRecycle = "$hostConnect/recycle";
  ...
  static const adminGetAllRecycle = "$hostConnectAdmin/read_recycle.php";
  ...
  //recycle
  static const checkAndUpload = "$hostRecycle/check&upload.php";
  static const getCargo = "$hostRecycle/getCargo.php";
  static const updateIBAN = "$hostRecycle/updateIBAN.php";
}