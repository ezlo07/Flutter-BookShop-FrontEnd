...
import 'package:clothes_app/users/fragments/recycle_fragment_screen.dart';
...
class DashboardOfFragments extends StatelessWidget {
  ...
  <Map<String, dynamic>>[
    ...
    {
      "active_icon": FontAwesomeIcons.recycle,
      "non_active_icon": FontAwesomeIcons.recycle,
      "label": "Recycle",
    },
    {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (controller) {
        return Scaffold(
          backgroundColor: Color(0xFF2B2B2B),//Arka plan
          body: SafeArea(
          ...
          bottomNavigationBar: Obx(() => BottomNavigationBar(
            ...
            selectedItemColor: Color(0xFFFFD700), //Başlık
